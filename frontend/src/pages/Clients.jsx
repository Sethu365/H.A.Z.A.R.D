...
const Clients = ({ setLoading, setError }) => {
  ...
  // 3. Sync Topbar Title via Layout Context
  useEffect(() => {
    if (setHeaderData) {
      setHeaderData({
  ...
  return (
    ...
    <div className="space-y-8 relative selection:bg-cyan-500/30">
          ...
          <AnimatePresence>
            {showAddMenu && (
              ...
              >
                ...
                <button onClick={() => handleDownload("linux")} className="w-full flex items-center justify-between px-4 py-3 hover:bg-white/5 rounded-xl transition-all group text-left">
                  <div className="flex items-center gap-3">
                ...
                <button onClick={() => handleDownload("windows")} className="w-full flex items-center justify-between px-4 py-3 hover:bg-white/5 rounded-xl transition-all group text-left">
                  <div className="flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {clients.length === 0 && !localLoading && (
          <div className="col-span-full p-20 text-center border border-dashed border-white/5 rounded-[2.5rem] text-gray-600 uppercase font-roboto-condensed tracking-widest">
