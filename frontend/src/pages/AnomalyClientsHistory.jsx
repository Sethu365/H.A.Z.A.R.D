...
const AnomalyClientsHistory = ({ setLoading, setError }) => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white selection:bg-purple-500/30 font-inter">
      ...
      <Topbar name={`Archive: ${hostname}`} desc="Historical_Forensic_Registry" />
                        ...
                        <div className="md:col-span-5 space-y-3 min-w-0">
                          ...
                          <div className="bg-white/[0.02] backdrop-blur-md border border-white/5 p-5 rounded-[2rem] h-full flex flex-col shadow-inner">
                            <div className="space-y-2 max-h-[220px] overflow-y-auto cyber-scroll pr-2 flex-1 font-jetbrains">
                              ...
                              )) : <div className="p-10 text-center text-gray-600 text-[8px] uppercase opacity-40">Isolation achieved // No patterns</div>}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-inter">
                        <div className="p-5 bg-red-500/5 border border-red-500/10 rounded-2xl flex items-center justify-between shadow-xl min-w-0">
                          <div className="flex items-center gap-2 min-w-0">
                             ...
                             <span className="text-[9px] font-black uppercase text-red-400 tracking-widest truncate">{selectedLog.summary || 'Historical deviation recorded'}</span>
                          </div>
                        </div>
                        <div className="p-5 bg-cyan-500/5 border border-cyan-500/10 rounded-2xl flex items-center justify-between shadow-xl min-w-0 font-jetbrains">
                          <div className="flex items-center gap-2 min-w-0">
                             <Terminal size={14} className="text-cyan-400 shrink-0" />
                             <span className="text-[9px] text-cyan-400 tracking-tight truncate uppercase">{selectedLog.command || "N/A"}</span>
                          </div>
                        </div>
                      </div>
                    </>
